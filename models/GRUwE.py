...
class Model(nn.Module):
    """
    - paper: "Still Competitive: Revisiting Recurrent Models for Irregular Time Series Prediction" (TMLR 2026)
    - paper link: https://openreview.net/forum?id=YLoZA77QzR
    - code adapted from: https://github.com/Ladbaby/PyOmniTS/pull/14

        original code https://github.com/ankit204/GRUwE
    """
    def __init__(self, configs: ExpConfigs):
        ...
        self.num_cells = configs.n_layers
        if self.num_cells < 1:
