...
class Model(nn.Module):
    """
    - paper: "FiLM: Frequency improved Legendre Memory Model for Long-term Time Series Forecasting" (NeurIPS 2022)
    - paper link: https://papers.nips.cc/paper_files/paper/2022/hash/524ef58c2bd075775861234266e5e020-Abstract-Conference.html
    ...
    def __init__(self, configs: ExpConfigs):
        ...
        if self.task_name == 'classification':
            ...
            self.projection = nn.Linear(
                configs.enc_in * configs.seq_len, configs.n_classes)
